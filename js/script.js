window.addEventListener('DOMContentLoaded', () => {
    ...
    //едлигирование событий и назначить обработчик событий
    ...
    function getTimeRemaining(endtime){
        ...
        const t = Date.parse(endtime) - Date.parse(new Date()); //окличесчестов млс
              if (t <= 0){
                days = 0; 
                hours = 0;
                minutes = 0;
    ...
    function setClock(selector, endtime){
        const timer = document.querySelector(selector),
              ...
              temeInterval = setInterval(updateClock,1000);
        //убрать мигание верстки при перзагрузки страницы
...
//использование сторонней библиотеки axios
    ...
    const message = {
        ...
        success: 'спасибо! Скоро мы с тобой свяжемся',
    ...
    fetch('http://localhost:3000/menu')
        ...
        if (slides.lenght < 10){
            // total.textContent = `0${slide.lenght}`;
